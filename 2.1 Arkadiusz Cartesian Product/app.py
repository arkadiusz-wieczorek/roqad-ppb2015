...
dataset_with_id = add_id.addUserID(random_sample, sys.argv[1] + 'labels.csv', 0)
#dataset_with_id = add_id.addUserID(sys.argv[2] + 'balanced.csv', sys.argv[1] + 'labels.csv', 1)
print "computing cartesian product (test)..."
cart_prod.cartesianProduct(dataset_with_id, sys.argv[2] + 'device_urls.csv', sys.argv[2] + 'result_cartesian_test.csv')
...
dataset_with_id = add_id.addUserID(random_sample, sys.argv[1] + 'labels.csv', 0)
#dataset_with_id = add_id.addUserID(sys.argv[2] + 'balanced.csv', sys.argv[1] + 'labels.csv', 1)
print "computing cartesian product (check)..."
cart_prod.cartesianProduct(dataset_with_id, sys.argv[2] + 'device_urls.csv', sys.argv[2] + 'result_cartesian_check.csv')
